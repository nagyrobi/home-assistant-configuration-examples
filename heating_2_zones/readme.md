...
## Requirements
- switches to control the heater pumps/valves (something like [Sonoff Mini](https://templates.blakadder.com/sonoff_mini.html) running Tasmota or ESPHome firmware) OR anything else like a RaspberryPi with a relay hat (examples provided)
